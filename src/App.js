...
const hotelItineraryList = [
  {
    ...
    hardware: { zh: "2018年开业。占地极大的高尔夫度假村，拥有27洞球场和私人海滩俱乐部，硬件宏伟且极新。", ko: "2018년 오픈. 27홀 골프장과 전용 비치 클럽을 갖춘 초대형 리조트로 시설이 웅장하고 새롭습니다." },
    service: { zh: "标准五星服务。因占地面积过大，出行高度依赖电瓶车 (Buggy)，旺季可能需要等待 10-15 分钟。", ko: "표준 5성급 서비스. 부지가 너무 넓어 버기카(Buggy)에 크게 의존하며, 성수기엔 10~15분 대기가 발생할 수 있습니다." },
    meals: { zh: "自助早餐丰盛，涵盖东西方菜系。由于周边点不到外卖，第一晚落地后建议直接在房间内或酒店餐厅解决宵夜。", ko: "조식 뷔페가 매우 풍성합니다. 주변 배달이 불가하므로 첫날 도착 후에는 호텔 내에서 식사를 해결하는 것을 추천합니다." },
    traffic: { zh: "距金兰机场仅 10-15 分钟车程，作为晚航班落地缓冲是完美的战略选择；距芽庄市区较远，约 45-60 分钟。", ko: "깜라인 공항에서 10~15분 거리로 늦은 밤 도착 시 완충용으로 완벽한 전략적 위치입니다. 냐짱 시내까지는 45~60분 소요." },
    commerce: { zh: "彻底的“荒郊野外”，周边为高尔夫球场和荒地，【完全没有便利店】。务必在机场先买好水和零食。", ko: "주변은 골프장과 공터뿐이며 【편의점이 전혀 없습니다】. 공항에서 미리 간식과 물을 사오는 것이 필수입니다." },
    benefits: { zh: "非万豪系。温德姆会员视房态可享延迟退房。作为第一晚主要用于洗漱补觉，无需强求高级权益，安心休息即可。", ko: "메리어트 계열 아님. 윈덤 회원은 상황에 따라 레잇 체크아웃 가능. 첫날 밤은 휴식과 수면이 목적이므로 혜택 부담이 적습니다." },
  },
  {
    ...
    hardware: { zh: "【2024年全新开业】主打健康与焕活体验，全配标志性“天梦之床”，设施极新，审美在线且极具度假感。", ko: "【2024년 신규 오픈】 웰빙과 리프레시를 강조하며, 시그니처 '헤븐리 베드'를 갖춘 최신식 고급 시설입니다." },
    service: { zh: "新开业酒店员工热情极高，服务响应快，整体营造出极其放松且现代的海滨度假氛围。", ko: "신규 호텔다운 열정적인 서비스와 빠른 응대로, 완벽하고 현대적인 해변 휴양 분위기를 제공합니다." },
    meals: { zh: "主打 Eat Well 菜单，健康早餐备受好评；酒店内的海鲜餐厅水准很高，非常适合海滨晚餐。", ko: "Eat Well 웰빙 조식이 호평을 받으며, 호텔 내 해산물 레스토랑의 수준이 높아 해변 저녁 식사로 제격입니다." },
    traffic: { zh: "位于金兰海湾度假村地带核心，打车或呼叫 Grab 前往机场约 15 分钟，去芽庄市区约 40 分钟。", ko: "깜라인 해변 리조트 단지 핵심에 위치하며, 공항까지 15분, 시내까지 40분 정도 소요됩니다." },
    commerce: { zh: "同属金兰海湾，周边依然缺乏独立商业区和便利店，消费基本需要在酒店内完成。", ko: "마찬가지로 깜라인 해변이라 독립적인 상권이나 편의점이 없어 소비는 주로 호텔 내에서 이루어집니다." },
    benefits: { zh: "钛金待遇极佳：极大概率直升带私人泳池的别墅或绝美尊贵海景房；含双早；无传统酒廊。配合 4PM 延迟退房，情侣度假感直接拉满。", ko: "티타늄 혜택 최고: 풀빌라 또는 프리미엄 오션뷰 룸으로 업그레이드될 확률이 높습니다. 2인 조식 제공(라운지 없음). 4PM 레잇 체크아웃과 최고의 조합입니다." },
  },
  {
    ...
    hardware: { zh: "前身是著名的珍珠岛度假村，翻牌万豪。拥有经典的法式与东南亚融合建筑、超大室外泳池与极佳的私家沙滩。", ko: "구 빈펄 리조트를 메리어트로 리브랜딩. 클래식한 프렌치/동남아 건축 양식에 초대형 야외 수영장과 훌륭한 전용 해변을 갖춤." },
    service: { zh: "经过万豪标准化培训，服务专业。岛上区域极其宽广，进出房间及前往沙滩均可随时呼叫 Buggy 接送。", ko: "메리어트 표준 교육을 받은 전문 서비스. 섬 내부 이동 시 언제든 버기카를 호출할 수 있습니다." },
    meals: { zh: "酒店内自助餐非常丰盛（晚餐约 80万越南盾/人）。也可选择去连通的 VinWonders 乐园内吃快餐。", ko: "호텔 내 조식/석식 뷔페가 매우 풍성합니다(인당 약 800k VND). VinWonders 테마파크 내 패스트푸드도 가능." },
    traffic: { zh: "进出需乘坐 24 小时免费快艇或跨海缆车上岛；上岛后去乐园等地方主要依赖酒店专属 Buggy。", ko: "24시간 무료 스피드보트나 케이블카로 섬에 진출입하며, 섬 내부에서는 주로 호텔 전용 버기카로 이동합니다." },
    commerce: { zh: "岛上绝对封闭，【完全没有便利店】。强烈建议在进岛前，于市区买好足够的饮用水、零食和泡面带上岛。", ko: "섬 내부가 완전히 독립되어 있어 【편의점이 전혀 없습니다】. 입도 전 시내에서 물, 간식, 컵라면을 넉넉히 사오는 것을 강력 추천합니다." },
    benefits: { zh: "钛金厚道：大概率升海景套房或独栋别墅；通常配有酒廊待遇。最关键的是 4PM 延迟退房，等于在岛上免费多赚大半天乐园时间！", ko: "티타늄 혜택 우수: 오션뷰 스위트나 풀빌라 업그레이드 확률이 높으며 보통 라운지 혜택이 제공됩니다. 4PM 레잇 체크아웃으로 섬을 반나절 더 즐길 수 있는 것이 핵심!" },
  },
  {
    ...
    hardware: { zh: "2020年开业的高层现代地标建筑，客房极具现代感，顶楼的无边泳池和玻璃健身房视野极其震撼。", ko: "2020년 오픈한 고층 현대식 랜드마크. 객실이 모던하며, 루프탑 인피니티 풀과 유리 피트니스 센터의 전망이 압도적입니다." },
    service: { zh: "高效、年轻且快捷。兼顾商务与城市休闲，前台办理入住与退房的速度在当地评价较高。", ko: "효율적이고 젊은 감각. 비즈니스와 휴양을 겸비했으며, 프런트 데스크의 빠른 일처리가 좋은 평가를 받습니다." },
    meals: { zh: "自助早餐性价比极高，种类丰富；顶楼的高空酒吧 (Altitude) 是芽庄极具人气的夜生活打卡地。", ko: "조식 뷔페의 가성비가 아주 훌륭합니다. 최상층 루프탑 바(Altitude)는 냐짱에서 매우 인기 있는 야간 명소입니다." },
    traffic: { zh: "位于市区陈富海滩偏北侧，打车随叫随到，去著名景点“婆那加占婆塔”比市中心其他酒店更近。", ko: "시내 쩐푸 해변 북쪽에 위치하며 택시 잡기가 아주 쉽습니다. 유명 명소인 '포나가르 참탑'과 더 가깝습니다." },
    commerce: { zh: "极其便利。楼下左转就是便利店和咖啡馆；晚餐可以直接溜达到著名的“清霜海鲜”吃平价大排档。", ko: "아주 편리합니다. 1층 바로 옆에 편의점과 카페가 있으며, 저녁엔 유명 가성비 식당 '탄스엉 해산물'에 걸어갈 수 있습니다." },
    benefits: { zh: "钛金通常会升级至高空全海景房或角房（该店套房极少）；含双人早餐及 4PM 延迟退房。注意该店无行政酒廊。", ko: "티타늄은 보통 고층 풀 오션뷰 룸이나 코너룸으로 업그레이드됩니다(스위트룸 수량 적음). 2인 조식 및 4PM 레잇 체크아웃. 라운지는 없습니다." },
  },
  {
    ...
    hardware: { zh: "2010年开业的芽庄老牌重磅地标。虽部分客房有年代感，但保养极佳，大堂与公共区域尽显经典五星奢华。", ko: "2010년 오픈한 냐짱의 대표적인 클래식 랜드마크. 객실에 연식이 조금 있지만 관리가 훌륭하며 로비는 5성급의 고급스러움을 풍깁니다." },
    service: { zh: "员工服务极其老道、专业，门童和礼宾部对周边的熟悉度极高，真正做到“有求必应”。", ko: "직원들의 서비스가 매우 노련하고 전문적입니다. 컨시어지가 주변 정보에 밝아 완벽한 응대를 제공합니다." },
    meals: { zh: "自助早餐极其丰盛（当地水准Top级别）；一楼的海鲜自助晚餐口碑极高；酒廊热食能直接当正餐。", ko: "조식 뷔페가 현지 최고 수준으로 풍성합니다. 1층 해산물 뷔페의 평가가 높고, 라운지 핫푸드도 정식 식사로 손색이 없습니다." },
    traffic: { zh: "霸占芽庄市区最核心的十字路口！下楼过一条马路即是专属私人沙滩区，打车去夜市和大坝市场都在起步价内。", ko: "냐짱 시내 가장 중심 사거리를 차지합니다! 길 하나 건너면 전용 해변이며, 야시장 및 담 시장까지 택시 기본요금입니다." },
    commerce: { zh: "极度繁华。被各种便利店、网红咖啡厅、按摩店和小吃街 360 度包围，晚上下楼闭眼逛即可。", ko: "극도로 번화함. 편의점, 유명 카페, 마사지 샵, 먹자골목에 360도로 둘러싸여 있어 밤에 걷기만 해도 좋습니다." },
    benefits: { zh: "极其厚道：钛金大概率升套或高层海景；包含极佳的行政酒廊待遇（下午茶+晚间欢乐时光），含双早，完美适配 4PM 退房。", ko: "티타늄 업그레이드(스위트 또는 고층 오션뷰)가 매우 후합니다. 퀄리티 높은 클럽 라운지(해피아워)가 제공되며 4PM 레잇 체크아웃과 최고의 조합입니다." },
  },
  {
    ...
    brand: { zh: "温德姆至尊 (Wyndham Grand) · 大型高尔夫度假村", ko: "윈덤 그랜드 · 대형 골프 리조트" },
    price: { zh: "约 300-600 元/晚", ko: "약 300-600 위안/박" },
    hardware: { zh: "再次回到此酒店，享受宽敞的客房与完善的高尔夫/海滨硬件设施，给长途行程收尾。", ko: "다시 이 호텔로 돌아와 넓은 객실과 해변/골프 시설을 즐기며 긴 일정을 마무리합니다." },
    service: { zh: "有了第一晚的经验，这次更能熟练运用 Buggy 和酒店各项服务时间表。", ko: "첫날의 경험을 바탕으로 버기카 및 호텔 서비스 시간을 더 효율적으로 이용할 수 있습니다." },
    meals: { zh: "依然建议在度假村内用餐。或在离开芽庄市区前，先饱餐一顿海鲜大餐，并采购好晚上的零食带来。", ko: "여전히 리조트 내 식사를 권장하며, 시내에서 출발하기 전에 해산물을 든든히 먹고 간식을 사오는 것이 좋습니다." },
    traffic: { zh: "战略意义极大：这里距离金兰机场仅十几分钟！能最大限度保证返程当天的从容，绝对避免市区堵车误机的风险。", ko: "전략적으로 아주 중요한 위치: 깜라인 공항까지 불과 10여 분! 귀국 당일 시내 교통체증 위험 없이 여유롭게 출발할 수 있습니다." },
    commerce: { zh: "此时已经不需要购物，安静的荒郊环境正好适合整理行李、收拾心情。", ko: "이제 쇼핑은 필요 없으므로, 조용한 외곽 환경에서 짐을 정리하고 마음을 차분히 하기에 딱 좋습니다." },
    benefits: { zh: "作为回国前的缓冲站，重点在于高效休息和极短的送机距离，抛开高级会员执念，安心踏上归途。", ko: "귀국 전 완충지로서 편안한 휴식과 짧은 공항 이동거리에 초점을 맞춥니다. 멤버십 혜택에 얽매이지 않고 편안히 귀국길에 오르세요." },
  },
];
...
const foodRecommendations = [
  {
    ...
    price: { zh: "约 1,000,000 VND 起 / 人", ko: "약 1,000,000 VND 부터 / 1인" },
    ...
    desc: { zh: "芽庄最有代表性的海鲜自助之一，主打无限龙虾与多国菜品，适合晚餐或纪念日。位置在陈富路一带，环境和出品都偏高端。", ko: "냐짱을 대표하는 고급 해산물 뷔페 중 하나로, 무제한 랍스터와 다양한 양식/현지 요리가 강점입니다. 기념일 저녁 식사로 잘 맞습니다." },
    menu: { zh: ["无限龙虾", "烤生蚝 / 扇贝", "刺身 / 沙拉", "牛排 / 甜品台"], ko: ["무제한 랍스터", "굴구이 / 가리비", "사시미 / 샐러드", "스테이크 / 디저트"] },
  },
  {
    category: { zh: "本地海鲜", ko: "현지 해산물" },
    name: { zh: "Thanh Suong Seafood", ko: "Thanh Suong Seafood" },
    tag: { zh: "本地人常去 · 价格透明", ko: "현지인 인기 · 가격 투명" },
    price: { zh: "约 250,000 - 400,000 VND / 人", ko: "약 250,000 - 400,000 VND / 1인" },
    ...
    desc: { zh: "芽庄很常见的海鲜排档类型，适合点一桌虾、螃蟹、贝类配炒饭或海鲜面。适合想吃得新鲜又不想花太多的人。", ko: "냐짱에서 흔히 볼 수 있는 해산물 식당 스타일로, 새우·게·조개류에 볶음밥이나 해산물면을 곁들이기 좋습니다." },
    menu: { zh: ["蒜蓉烤龙虾", "葱油烤扇贝", "海鲜炒面", "蟹 / 虾 / 贝类"], ko: ["갈릭 랍스터", "파기름 가리비", "해산물 볶음면", "게 / 새우 / 조개"] },
  },
  {
    category: { zh: "本地烧烤", ko: "현지 바비큐" },
    name: { zh: "Lac Canh Restaurant", ko: "Lac Canh Restaurant" },
    tag: { zh: "炭烤牛肉 · 老牌名店", ko: "숯불 소고기 · 오래된 명점" },
    price: { zh: "约 200,000 - 350,000 VND / 人", ko: "약 200,000 - 350,000 VND / 1인" },
    ...
    desc: { zh: "芽庄很有名的炭烤牛肉店，适合多人一起点肉类和烤菜。整体更偏热闹、接地气，属于本地常吃的类型。", ko: "냐짱의 유명한 숯불 소고기 집으로, 여러 명이 함께 고기와 구이류를 먹기 좋습니다. 분위기는 소박하고 활기찬 편입니다." },
    menu: { zh: ["炭烤牛肉", "烤虾", "烤鱿鱼", "米饭 / 米纸卷"], ko: ["숯불 소고기", "구운 새우", "구운 오징어", "밥 / 라이스페이퍼"] },
  },
  {
    ...
    price: { zh: "约 40,000 - 90,000 VND / 人", ko: "약 40,000 - 90,000 VND / 1인" },
    ...
    desc: { zh: "芽庄非常典型的 nem nướng 老店，通常会配米纸、生菜、香草和蘸酱一起吃。适合当午餐、下午加餐或晚餐前垫一口。", ko: "냐짱의 대표적인 nem nướng 맛집으로, 라이스페이퍼·상추·허브·소스와 함께 싸 먹습니다. 점심이나 간식으로 딱 좋습니다." },
    menu: { zh: ["Nem nướng", "米纸卷", "炸春卷", "越南香草"], ko: ["넴느엉", "라이스페이퍼롤", "튀김춘권", "허브류"] },
  },
  {
    category: { zh: "越南小吃", ko: "베트남 스트리트 푸드" },
    name: { zh: "Bánh Căn 51 Tô Hiến Thành", ko: "Bánh Căn 51 Tô Hiến Thành" },
    tag: { zh: "小饼 + 海鲜蘸酱", ko: "미니 팬케이크 + 해산물 소스" },
    price: { zh: "约 30,000 - 70,000 VND / 人", ko: "약 30,000 - 70,000 VND / 1인" },
    ...
    desc: { zh: "适合想尝芽庄本地小吃的人，常见是小铁盘现做的 bánh căn，配海鲜、鸡蛋和蘸酱。份量不大，但很有地方特色。", ko: "냐짱 로컬 간식을 맛보고 싶을 때 좋은 곳입니다. 작은 틀에서 즉석으로 굽는 bánh căn에 해산물, 계란, 소스를 곁들입니다." },
    menu: { zh: ["Bánh căn", "Bánh xèo", "海鲜蘸酱", "蛋 / 虾 / 鱿鱼"], ko: ["반깐", "반쎄오", "해산물 소스", "계란 / 새우 / 오징어"] },
  },
  {
    category: { zh: "面包", ko: "바게트" },
    name: { zh: "Banh Mi Phan", ko: "Banh Mi Phan" },
    tag: { zh: "平价三明治 · 出餐快", ko: "가성비 샌드위치 · 빠른 제공" },
    price: { zh: "约 25,000 - 40,000 VND / 个", ko: "약 25,000 - 40,000 VND / 개" },
    ...
    desc: { zh: "芽庄很方便的一类越南法棍店，适合早餐、赶路或夜宵。出餐快、价格低，口味稳定，适合随手吃一个。", ko: "냐짱에서 편하게 먹기 좋은 베트남식 바게트 가게입니다. 아침·이동 중·야식 모두 잘 맞고, 가격도 부담이 적습니다." },
    menu: { zh: ["烤肉法棍", "鸡肉法棍", "素食法棍", "牛油果 / 蛋"], ko: ["고기 바게트", "치킨 바게트", "채식 바게트", "아보카도 / 계란"] },
  },
  {
    category: { zh: "咖啡饮品", ko: "커피 / 음료" },
    name: { zh: "CCCP Coffee", ko: "CCCP Coffee" },
    tag: { zh: "椰子咖啡 · 强冷气", ko: "코코넛 커피 · 에어컨 강함" },
    price: { zh: "约 45,000 - 70,000 VND / 杯", ko: "약 45,000 - 70,000 VND / 잔" },
    ...
    desc: { zh: "很适合中午避暑或者安排拍照休息。常见推荐是椰子咖啡、冰沙和各种甜饮，属于市区里比较舒服的中途停靠点。", ko: "한낮에 더위를 피하거나 사진 찍고 쉬기 좋습니다. 코코넛 커피, 스무디, 달콤한 음료가 대표적이며 시내 중간 휴식지로 좋습니다." },
    menu: { zh: ["椰子咖啡", "芒果冰沙", "冰拿铁", "甜饮 / 冰沙"], ko: ["코코넛 커피", "망고 스무디", "아이스 라테", "달콤한 음료 / 스무디"] },
  },
  {
    category: { zh: "甜品", ko: "디저트" },
    name: { zh: "Sweet Secret", ko: "Sweet Secret" },
    tag: { zh: "蛋糕甜品 · 高分口碑", ko: "케이크 디저트 · 높은 평점" },
    price: { zh: "约 50,000 - 120,000 VND / 份", ko: "약 50,000 - 120,000 VND / 인분" },
    ...
    desc: { zh: "适合饭后补一个甜点，环境通常更偏安静和精致。比较适合情侣旅行里当作下午茶或晚餐收尾。", ko: "식사 후 디저트를 넣기 좋은 곳으로, 분위기가 비교적 조용하고 깔끔합니다. 커플 여행의 애프터눈 티나 식사 마무리로 잘 맞습니다." },
    menu: { zh: ["芝士蛋糕", "慕斯蛋糕", "冰淇淋", "咖啡 / 茶"], ko: ["치즈케이크", "무스케이크", "아이스크림", "커피 / 차"] },
  },
  {
    category: { zh: "面包 / 烘焙", ko: "베이커리" },
    name: { zh: "Củi Bánh Mì", ko: "Củi Bánh Mì" },
    tag: { zh: "现烤面包 · 更适合早餐", ko: "갓 구운 빵 · 아침용" },
    price: { zh: "约 30,000 - 60,000 VND / 份", ko: "약 30,000 - 60,000 VND / 인분" },
    ...
    desc: { zh: "更偏烘焙店气质，适合做早餐、带走或和咖啡一起点。想吃得清爽一点时，这类店很实用。", ko: "베이커리 성격이 강해서 아침식사, 테이크아웃, 커피와 함께 주문하기 좋습니다. 가볍게 먹고 싶을 때 실용적입니다." },
    menu: { zh: ["现烤法棍", "火腿三明治", "奶油面包", "甜点面包"], ko: ["갓 구운 바게트", "햄 샌드위치", "크림빵", "디저트 빵"] },
  },
];
...
const itinerary = [
    ...
    slots: [
      {
        ...
        period: "night",
        icon: "✈️",
        title: { zh: "金兰机场落地 → 打 Grab 到酒店", ko: "깜라인 공항 도착 → Grab으로 호텔 이동" },
        desc: {
      ...
      },
      {
        ...
        period: "night",
        icon: "🌙",
        title: { zh: "宵夜 + 入睡，整理明日行李", ko: "야식 + 취침, 다음 날 짐 준비" },
        desc: {
  ...
  /* ── 第2天 ── */
  {
    ...
    title: { zh: "威斯汀度假日：海滩 · Spa · 慢节奏", ko: "웨스틴 리조트의 하루: 해변 · 스파 · 여유" },
    ...
    slots: [
      {
        ...
        period: "morning",
        icon: "🍳",
        title: { zh: "威斯汀 Eat Well 健康早餐", ko: "웨스틴 Eat Well 건강 조식" },
        desc: {
      ...
      },
      {
        ...
        period: "morning",
        icon: "🏖️",
        title: { zh: "威斯汀私人海滩 + 泳池时光", ko: "웨스틴 전용 해변 + 수영장 시간" },
        desc: {
        ...
        options: [
          {
            ...
            icon: "🧖",
            title: { zh: "威斯汀天韵水疗 Heavenly Spa", ko: "웨스틴 헤븐리 스파" },
            desc: {
            ...
            venues: [
              {
                ...
                address: { zh: "威斯汀金兰度假村酒店内，步行 2 分钟到达", ko: "웨스틴 깜라인 리조트 내, 도보 2분" },
                price: { zh: "60 分钟约 1,200,000 VND；90 分钟约 1,800,000 VND（含双人包房设施）", ko: "60분 약 1,200,000 VND; 90분 약 1,800,000 VND (커플 룸 포함)" },
                rating: "⭐⭐⭐⭐⭐",
                tip: { zh: "早餐后立即预约！旺季（7月）下午档位极易满，尤其是 15:00-17:00 的情侣双人间。", ko: "조식 후 즉시 예약하세요! 7월 성수기 오후 15:00~17:00 커플 룸은 금방 찹니다." }
              }
            ],
          },
          {
            tag: { zh: "B 可选 · 进市区半日游", ko: "B 대안 · 시내 반나절 나들이" },
            icon: "🚕",
            title: { zh: "Grab 进芽庄市区轻游（仅限精力充沛时）", ko: "Grab으로 냐짱 시내 반나절 나들이 (체력 여유 있을 때만)" },
            desc: {
      ...
      },
      {
        ...
        period: "evening",
        icon: "🌅",
        title: { zh: "日落海景 + 威斯汀海鲜晚餐", ko: "석양 감상 + 웨스틴 해산물 저녁식사" },
        desc: {
  ...
  /* ── 第3天 ── */
  {
    ...
    title: { zh: "缆车上岛 · VinWonders · Tata Show 夜间灯光秀", ko: "케이블카 입도 · VinWonders · Tata Show 야간 공연" },
    ...
    slots: [
      {
        ...
        period: "morning",
        icon: "🍳",
        title: { zh: "威斯汀最后一顿早餐 + 整理退房", ko: "웨스틴 마지막 조식 + 체크아웃 준비" },
        desc: {
      ...
      },
      {
        ...
        options: [
          {
            tag: { zh: "A 强推 · 跨海缆车（必体验！）", ko: "A 강추 · 해상 케이블카 (필수 체험!)" },
            icon: "🚡",
            title: { zh: "VinWonders 跨海缆车 —— 空中俯瞰芽庄湾", ko: "VinWonders 해상 케이블카 — 공중에서 내려다보는 냐짱만" },
            desc: {
            ...
            venues: [
              {
                name: "VinWonders 缆车站 / Cáp treo Vinpearl",
                address: { zh: "Đường 2 Tháng 4，陈富路海滨；从威斯汀 Grab 约 45 分钟", ko: "Đường 2 Tháng 4, 쩐푸 해변 인근; 웨스틴에서 Grab 약 45분" },
                price: { zh: "含在 VinWonders 全日票内（成人约 1,050,000 VND）", ko: "VinWonders 종일권에 포함 (성인 약 1,050,000 VND)" },
                rating: "⭐⭐⭐⭐⭐",
                tip: { zh: "排队高峰在 9:00-10:00，11:00 左右更顺；旺季强烈建议提前在官网购票！", ko: "혼잡 피크: 09:00~10:00. 11시경에 타면 대기 짧음. 성수기엔 공식 사이트 사전 구매 강력 권장!" }
              }
            ],
          },
          {
            tag: { zh: "B 省时 · 万豪专属快艇", ko: "B 시간 절약 · 메리어트 전용 스피드보트" },
            icon: "🚤",
            title: { zh: "乘万豪 24h 免费快艇直抵岛上", ko: "메리어트 24시간 무료 스피드보트로 빠르게 입도" },
            desc: {
      ...
      },
      {
        ...
        period: "afternoon",
        icon: "🏨",
        title: { zh: "万豪入住 + 简单午餐", ko: "메리어트 체크인 + 간단한 점심" },
        desc: {
      ...
      },
      {
        ...
        period: "afternoon",
        icon: "🎢",
        title: { zh: "VinWonders 下午全力冲刺！", ko: "VinWonders 오후 풀 스로틀!" },
        desc: {
        ...
        venues: [
          {
            ...
            address: { zh: "Hon Tre 岛内（缆车/快艇即抵）", ko: "혼쩨(Hon Tre) 섬 내 (케이블카·보트로 입장)" },
            price: { zh: "成人全日票约 1,050,000 VND；官网优惠码 NIHAO5 享 5% 折扣；提前 7 天购买额外 3% 折扣", ko: "성인 종일권 약 1,050,000 VND; 공식 사이트 코드 NIHAO5 5% 할인; 7일 전 구매 시 추가 3% 할인" },
            rating: "⭐⭐⭐⭐",
            tip: { zh: "营业约 09:00-20:00（旺季可延长）；Tata Show 每日 19:30 在 VinPearl Harbour 水上舞台，周五/周日额外有烟火表演！", ko: "운영 약 09:00~20:00 (성수기 연장). Tata Show 매일 19:30 빈펄 하버 수상 무대; 금·일요일엔 불꽃놀이 추가!" }
          }
        ],
      },
      {
        ...
        period: "evening",
        icon: "🎭",
        title: { zh: "晚餐 + Tata Show 水上灯光秀", ko: "저녁식사 + Tata Show 수상 공연" },
        desc: {
  ...
  /* ── 第4天 ── */
  {
    ...
    title: { zh: "VinWonders 续玩 · 离岛回市区 · 占婆塔+钟屿+夜市", ko: "VinWonders 이어서 · 섬 출발 · 참탑+혼쫑+야시장" },
    ...
    slots: [
      {
        ...
        period: "morning",
        icon: "🎡",
        title: { zh: "万豪早餐 + VinWonders 上午补玩", ko: "메리어트 조식 + VinWonders 오전 추가 체험" },
        desc: {
      ...
      },
      {
        ...
        period: "afternoon",
        icon: "🚤",
        title: { zh: "离岛 → 回市区 → 入住 Four Points", ko: "섬 출발 → 시내 이동 → 포포인츠 체크인" },
        desc: {
      ...
      },
      {
        ...
        period: "afternoon",
        icon: "🏛️",
        title: { zh: "占婆塔 + 钟屿石岬角连线（经典文化串游）", ko: "포나가르 참탑 + 혼쫑 연계 코스 (클래식 문화 루트)" },
        desc: {
      ...
      },
      {
        time: "19:00–22:00",
        period: "evening",
        altLabel: { zh: "晚餐 + 夜间活动选择", ko: "저녁식사 + 야간 활동 선택" },
        tip: null,
        options: [
          {
            tag: { zh: "A 推荐 · 海鲜 + 屋顶酒吧", ko: "A 추천 · 해산물 + 루프탑 바" },
            icon: "🦞",
            title: { zh: "清霜海鲜大排档 + Altitude 屋顶酒吧", ko: "탄스엉 해산물 + Altitude 루프탑 바" },
            desc: {
            ...
            venues: [
              {
                name: "Thanh Suong Seafood (清霜海鲜)",
                address: { zh: "Four Points 北侧步行约 3 分钟，陈富路一带", ko: "포포인츠에서 북쪽 도보 3분, 쩐푸 해변 인근" },
                price: { zh: "约 250,000–400,000 VND/人", ko: "약 250,000~400,000 VND/인" },
                rating: "⭐⭐⭐⭐",
                tip: { zh: "营业至深夜，不接受预约先到先得；旺季 20:00 前后最热闹，略需等位。", ko: "심야까지 영업, 예약 불가 선착순. 성수기 20:00 전후 가장 붐비니 그 전에 가는 게 좋습니다." }
              },
              {
                name: "Altitude Rooftop Bar",
                address: { zh: "Four Points by Sheraton 顶楼，电梯直达", ko: "포포인츠 바이 쉐라톤 최상층, 엘리베이터 직행" },
                price: { zh: "鸡尾酒约 150,000–250,000 VND/杯", ko: "칵테일 약 150,000~250,000 VND/잔" },
                rating: "⭐⭐⭐⭐⭐",
                tip: null
              }
            ],
          ...
          {
            tag: { zh: "B 可选 · 夜市街头觅食", ko: "B 대안 · 야시장 거리 음식 탐방" },
            icon: "🌃",
            title: { zh: "芽庄夜市 (Chợ Đêm) 街头逛吃", ko: "냐짱 야시장 거리 음식 투어" },
            desc: {
  ...
  /* ── 第5天 ── */
  {
    ...
    title: { zh: "上午：潜水/泥浴二选一 · 下午寺庙 · 晚间顶级 Spa", ko: "오전: 다이빙/머드배스 선택 · 오후 사원 · 저녁 스파" },
    hotel: "Sheraton Nha Trang Hotel & Spa",
    slots: [
      {
        time: "07:30–14:00",
        period: "morning",
        altLabel: { zh: "上午活动（两条路线，二选一）", ko: "오전 활동 (두 가지 루트 중 하나 선택)" },
        tip: null,
        options: [
          {
            tag: { zh: "A 强推 · 黑岛潜水一日游", ko: "A 강추 · 혼문 스쿠버다이빙 일일 투어" },
            icon: "🤿",
            title: { zh: "黑岛 (Hon Mun) 精品潜水 / 浮潜一日游", ko: "혼문 섬 (흑도) 스쿠버다이빙 / 스노클링 일일 투어" },
            desc: {
            ...
            venues: [
              {
                name: "推荐机构：Rainbow Divers Nha Trang",
                address: { zh: "Cầu Đá 码头集合（距喜来登打 Grab 约 10 分钟，50,000 VND）", ko: "Cầu Đá 부두 (쉐라톤에서 Grab 약 10분, 50,000 VND)" },
                price: { zh: "体验潜水（无证）约 1,200,000–1,500,000 VND/人；双气瓶持证约 1,800,000–2,500,000 VND/人；均含快艇·装备·午餐", ko: "체험 다이빙(무자격) 약 1,200,000~1,500,000 VND/인; 자격증 2탱크 약 1,800,000~2,500,000 VND/인; 보트·장비·점심 포함" },
                rating: "⭐⭐⭐⭐⭐",
                tip: { zh: "Rainbow Divers 是芽庄最老牌、口碑最好的英文潜水机构之一，安全性极高。也可通过喜来登礼宾部推荐提供中文服务的当地潜水团。", ko: "Rainbow Divers는 냐짱 최고 평점의 다이빙 전문 업체입니다. 한국어/중국어 가이드 투어는 호텔 컨시어지를 통해 추천받으세요." }
              }
            ],
          },
          {
            tag: { zh: "B 休闲版 · 泥浴温泉", ko: "B 여유 버전 · 머드배스 온천" },
            icon: "🛁",
            title: { zh: "I-Resort 矿泥浴 + 双人私密池（芽庄最推荐的泥浴）", ko: "I-Resort 미네랄 머드배스 + 2인 프라이빗 탕 (냐짱 최고 추천)" },
            desc: {
            ...
            venues: [
              {
                name: "I-Resort 矿泉泥浴中心",
                address: { zh: "19 Xuân Ngọc, Vĩnh Ngọc，芽庄市区北约 7 公里", ko: "19 Xuân Ngọc, Vĩnh Ngọc, 냐짱 시내 북쪽 약 7km" },
                price: { zh: "2 人私密泥浴约 350,000 VND/人；含矿泉温泉池使用权；入园费约 100,000-150,000 VND/人（两项合计约 500,000 VND/人）", ko: "2인 프라이빗 머드배스 약 350,000 VND/인; 온천 풀 포함; 입장료 약 100,000~150,000 VND/인 (합계 약 500,000 VND/인)" },
                rating: "⭐⭐⭐⭐",
                tip: { zh: "开放 08:00-17:30（最晚 16:30 入园）；旺季 10:00 前到场更舒适；记得带沐浴液或提前向园区购买。", ko: "운영: 08:00~17:30 (16:30 마지막 입장). 성수기엔 오전 10시 전 도착이 쾌적. 샤워 젤을 챙기거나 현장 구매 가능." }
              }
            ],
          },
        ],
      },
      {
        ...
        period: "afternoon",
        icon: "🏯",
        title: { zh: "龙山寺 + 大教堂（或二选一）+ 咖啡休息", ko: "롱선사 + 대성당 (또는 둘 중 하나) + 카페 휴식" },
        desc: {
      ...
      },
      {
        time: "18:00–20:00",
        period: "evening",
        altLabel: { zh: "晚间 Spa（提前预约！）", ko: "저녁 스파 (사전 예약 필수!)" },
        tip: {
        ...
        options: [
          {
            tag: { zh: "A 强推 · Sen Spa (芽庄排名第一)", ko: "A 강추 · Sen Spa (냐짱 평점 1위)" },
            icon: "🌸",
            title: { zh: "Sen Spa 90 分钟精油/泰式按摩", ko: "Sen Spa 90분 아로마/타이 마사지" },
            desc: {
            ...
            venues: [
              {
                ...
                address: { zh: "Số 5, Lý Thánh Tôn, TP Nha Trang（距喜来登步行约 10 分钟，打 Grab 约 5 分钟）", ko: "Số 5, Lý Thánh Tôn, 냐짱 (쉐라톤에서 도보 약 10분, Grab 5분)" },
                price: { zh: "90 分钟精油/泰式/深层按摩约 400,000–600,000 VND/人（两人合计约 1,200,000 VND 以内）", ko: "90분 아로마/타이/딥티슈 마사지 약 400,000~600,000 VND/인 (2인 합계 약 1,200,000 VND 이하)" },
                rating: "⭐⭐⭐⭐⭐ (Google 4.9 · TripAdvisor 名人堂)",
                tip: { zh: "📞 0258 382 9899；营业 08:30-20:30；WhatsApp 可预约；官网 senspanhatrang.com 可查完整价格表。小费建议每位约 2 USD（当地惯例）。", ko: "📞 0258 382 9899; 영업 08:30~20:30; WhatsApp 예약 가능; senspanhatrang.com에서 전체 메뉴·가격 확인. 팁은 인당 약 2달러 권장 (현지 관례)." }
              }
            ],
          },
          {
            tag: { zh: "B 可选 · SuSpa (中国客热门，可当天约)", ko: "B 대안 · SuSpa (중국인 인기, 당일 예약 가능)" },
            icon: "🧴",
            title: { zh: "Su Spa 60 分钟越式精油按摩", ko: "Su Spa 60분 베트남식 오일 마사지" },
            desc: {
            ...
            venues: [
              {
                name: "Su Spa",
                address: { zh: "229 Nguyễn Thiện Thuật, TP Nha Trang（距喜来登约 1.5 公里，打 Grab 5 分钟）", ko: "229 Nguyễn Thiện Thuật, 냐짱 (쉐라톤에서 약 1.5km, Grab 5분)" },
                price: { zh: "60 分钟越式精油按摩约 95–120 元人民币（通过飞猪/携程提前购买更优惠）", ko: "60분 베트남식 오일 마사지 약 95~120위안 (씨트립/페이저우 사전 구매가 더 저렴)" },
                rating: "⭐⭐⭐⭐",
                tip: { zh: "营业 09:00-22:00，中文沟通无障碍。按摩前填需求表（力道轻重、重点部位），越式需脱至内裤，属正常流程。", ko: "영업: 09:00~22:00. 중국어 소통 가능. 마사지 전 요구사항 체크리스트 작성 (강도, 중점 부위). 베트남식은 속옷만 남기는 것이 정상 과정." }
              }
            ],
          },
        ],
      },
      {
        ...
        period: "evening",
        icon: "🦞",
        title: { zh: "喜来登晚餐：海鲜自助 or 酒廊欢乐时光", ko: "쉐라톤 저녁: 해산물 뷔페 또는 클럽 라운지 해피아워" },
        desc: {
  ...
  /* ── 第6天 ── */
  {
    ...
    title: { zh: "大坝市场扫货 · 告别海鲜 · 返回金兰海湾", ko: "담 시장 쇼핑 · 작별 해산물 만찬 · 깜라인 귀환" },
    hotel: "Wyndham Grand KN Paradise Cam Ranh",
    slots: [
      {
        time: "08:30–10:00",
        period: "morning",
        icon: "🍳",
        title: { zh: "喜来登最后一顿丰盛早餐", ko: "쉐라톤 마지막 조식 (이번 여행 최고 조식)" },
        desc: {
      ...
      },
      {
        ...
        period: "morning",
        icon: "🛒",
        title: { zh: "大坝市场（Chợ Đầm）集中采购伴手礼", ko: "담 시장(Chợ Đầm) 기념품 집중 쇼핑" },
        desc: {
        ...
        venues: [
          {
            name: "大坝市场 (Chợ Đầm)",
            address: { zh: "Phan Bội Châu，芽庄市中心，打 Grab 从喜来登约 5 分钟", ko: "Phan Bội Châu, 냐짱 시내 중심, 쉐라톤에서 Grab 5분" },
            price: { zh: "免费入场；咖啡 1kg 约 200,000 VND，腰果 500g 约 100,000–150,000 VND", ko: "무료 입장. 커피 1kg 약 200,000 VND, 캐슈넛 500g 약 100,000~150,000 VND" },
            rating: "⭐⭐⭐⭐",
            tip: null
          }
        ],
      },
      {
        time: "12:30–14:00",
        period: "afternoon",
        altLabel: { zh: "芽庄最后一顿正餐（告别大餐）", ko: "냐짱 마지막 식사 (작별 만찬)" },
        tip: null,
        options: [
          {
            tag: { zh: "A 豪华 · 无限龙虾自助", ko: "A 고급 · 무제한 랍스터 뷔페" },
            icon: "🦞",
            title: { zh: "Ngon Gallery · 芽庄代表性无限龙虾自助", ko: "Ngon Gallery · 냐짱 대표 무제한 랍스터 뷔페" },
            desc: {
            ...
            venues: [
              {
                ...
                address: { zh: "陈富路附近（具体地址可通过 Google Maps 搜索 Ngon Gallery Nha Trang）", ko: "쩐푸 해변 인근 (Google Maps에서 'Ngon Gallery Nha Trang' 검색)" },
                price: { zh: "约 1,000,000 VND 起 / 人（无限龙虾午餐套餐）", ko: "약 1,000,000 VND 이상 / 인 (무제한 랍스터 런치 패키지)" },
                rating: "⭐⭐⭐⭐⭐",
                tip: { zh: "午餐价比晚餐低约 20%，14:00 前到性价比最高。提前电话或通过携程预约，旺季座位非常紧张。", ko: "점심이 저녁보다 약 20% 저렴, 14:00 전 방문이 가성비 최고. 전화 또는 씨트립으로 사전 예약, 성수기엔 자리가 금방 찹니다." }
              }
            ],
          },
          {
            ...
            icon: "🥩",
            title: { zh: "Lac Canh · 芽庄老字号炭烤牛肉", ko: "Lac Canh · 냐짱 원조 숯불 소고기 맛집" },
            desc: {
            ...
            venues: [
              {
                ...
                address: { zh: "44 Nguyễn Bỉnh Khiêm，距喜来登步行约 10 分钟", ko: "44 Nguyễn Bỉnh Khiêm, 쉐라톤에서 도보 약 10분" },
                price: { zh: "约 200,000–350,000 VND/人", ko: "약 200,000~350,000 VND/인" },
                rating: "⭐⭐⭐⭐",
                tip: null
              }
            ],
      ...
      },
      {
        ...
        period: "afternoon",
        icon: "🚕",
        title: { zh: "Grab 返回金兰海湾，最后一夜安顿", ko: "Grab으로 깜라인 복귀, 마지막 밤 안착" },
        desc: {
      ...
      },
      {
        ...
        period: "evening",
        icon: "🌙",
        title: { zh: "度假村轻松晚餐 + 看星空 + 早睡", ko: "리조트 가벼운 저녁 + 별 구경 + 일찍 취침" },
        desc: {
  ...
  /* ── 第7天 ── */
  {
    ...
    title: { zh: "整理行李 · 从容去机场 · 带着美好记忆回家", ko: "짐 정리 · 여유로운 공항 이동 · 아름다운 추억과 함께 귀국" },
    hotel: { zh: "Wyndham Grand KN Paradise（完美的机场缓冲站）", ko: "윈덤 그랜드 KN 파라다이스 (완벽한 공항 완충 기지)" },
    slots: [
      {
        time: "航班前 2.5 小时",
        period: "morning",
        icon: "⏰",
        title: { zh: "起床整理 → 叫车去金兰机场", ko: "기상 정리 → 공항으로 출발" },
        desc: {
      ...
      },
      {
        ...
        period: "morning",
        icon: "🎁",
        title: { zh: "机场免税区最后采购 + 告别芽庄", ko: "공항 면세구역 마지막 쇼핑 + 냐짱 작별" },
        desc: {
...
function HotelItineraryCard({ h, lang }) {
  return (
    <Card accent>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12, flexWrap: "wrap", paddingBottom: 16, marginBottom: 16, borderBottom: "1px dashed #dbe3ea" }}>
        <div>
          <div style={{ display: "inline-block", background: "#e07055", color: "#fff", padding: "4px 10px", borderRadius: 8, fontSize: 13, fontWeight: 900, marginBottom: 8 }}>
            {lang === "zh" ? h.date.zh : h.date.ko}
          </div>
          <div style={{ fontSize: 20, fontWeight: 900, color: "#0e2d4d" }}>{h.name}</div>
          <div style={{ color: "#6b7280", fontSize: 14, marginTop: 6, fontWeight: 700 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 16 }}>
        <InfoItem icon="🏛️" title={lang === "zh" ? "历史与硬件" : "역사 및 시설"} text={lang === "zh" ? h.hardware.zh : h.hardware.ko} />
        <InfoItem icon="🛎️" title={lang === "zh" ? "服务水平" : "서비스 수준"} text={lang === "zh" ? h.service.zh : h.service.ko} />
        <InfoItem icon="🍳" title={lang === "zh" ? "餐饮与早午餐" : "식음료 및 조식"} text={lang === "zh" ? h.meals.zh : h.meals.ko} />
        <InfoItem icon="🚕" title={lang === "zh" ? "周边交通" : "주변 교통"} text={lang === "zh" ? h.traffic.zh : h.traffic.ko} />
        <InfoItem icon="🛍️" title={lang === "zh" ? "周边商业" : "주변 상권"} text={lang === "zh" ? h.commerce.zh : h.commerce.ko} />
        <InfoItem icon="💎" title={lang === "zh" ? "钛金会员权益" : "티타늄 멤버십 혜택"} text={lang === "zh" ? h.benefits.zh : h.benefits.ko} />
      </div>
    </Card>
  );
}
  ...
  return (
    <Card>
      <div style={{ display: "flex", gap: 16, flexWrap: "wrap", alignItems: "stretch" }}>
        <div style={{ flexShrink: 0, width: 150, height: 150, borderRadius: 16, overflow: "hidden", border: "1px solid #e8e0d4", background: "linear-gradient(135deg, #f8fafc 0%, #eef2f7 100%)", position: "relative" }}>
          {f.img ? (
            <img src={f.img} alt={lang === "zh" ? f.name.zh : f.name.ko} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
          ) : (
            <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", color: "#94a3b8", fontWeight: 800, fontSize: 13, textAlign: "center", padding: 12 }}>
              {lang === "zh" ? "暂无图片" : "이미지 없음"}
            </div>
          )}
        </div>
        <div style={{ flex: 1, minWidth: 240 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 10, flexWrap: "wrap" }}>
            <div>
              <div style={{ fontSize: 19, fontWeight: 900, color: "#0e2d4d" }}>{lang === "zh" ? f.name.zh : f.name.ko}</div>
              <div style={{ marginTop: 6, display: "flex", flexWrap: "wrap" }}>
                <span style={{ display: "inline-block", padding: "5px 10px", borderRadius: 999, background: "#edf4fb", color: "#0e2d4d", fontSize: 12, fontWeight: 800, marginBottom: 6 }}>
                  {lang === "zh" ? f.category.zh : f.category.ko}
                </span>
                <span style={{ display: "inline-block", padding: "5px 10px", borderRadius: 999, background: "#fff4ed", color: "#c2410c", fontSize: 12, fontWeight: 800, marginLeft: 8, marginBottom: 6 }}>
                  {lang === "zh" ? f.tag.zh : f.tag.ko}
                </span>
              </div>
            </div>
            <div style={{ background: "#fef2f2", color: "#dc2626", padding: "6px 10px", borderRadius: 10, fontSize: 13, fontWeight: 800, whiteSpace: "nowrap" }}>
              {lang === "zh" ? f.price.zh : f.price.ko}
            </div>
          </div>
          <div style={{ marginTop: 12, fontSize: 14, color: "#334155", lineHeight: 1.75 }}>{lang === "zh" ? f.desc.zh : f.desc.ko}</div>
          {f.menu && (
            <div style={{ marginTop: 12 }}>
              <div style={{ fontSize: 13, fontWeight: 800, color: "#0e2d4d", marginBottom: 8 }}>{lang === "zh" ? "推荐菜单" : "추천 메뉴"}</div>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                {(lang === "zh" ? f.menu.zh : f.menu.ko).map((item) => (
                  <span key={item} style={{ display: "inline-block", padding: "6px 10px", borderRadius: 999, background: "#f8fafc", border: "1px solid #e2e8f0", color: "#334155", fontSize: 12, fontWeight: 700 }}>
                    {item}
                  </span>
                ))}
              </div>
          ...
          {f.mapLink && (
            <a href={f.mapLink} target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 6, marginTop: 14, padding: "8px 14px", background: "#edf4fb", color: "#0e2d4d", fontSize: 13, fontWeight: 800, textDecoration: "none", borderRadius: 10 }}>
...
function ItineraryDayCard({ d, lang }) {
  ...
  const periodMeta = {
    morning:   { border: "#fb923c", bg: "#fff7ed", label: isZh ? "上午" : "오전" },
    afternoon: { border: "#60a5fa", bg: "#eff6ff", label: isZh ? "下午" : "오후" },
    evening:   { border: "#c084fc", bg: "#fdf4ff", label: isZh ? "晚间" : "저녁" },
  ...
  return (
    <div style={{
      background: "#fff",
      border: d.isHighlight ? "2px solid #0e2d4d" : "1px solid #e8e0d4",
      borderRadius: 18,
      padding: "20px 22px",
      boxShadow: "0 8px 24px rgba(20,30,50,0.05)",
    }}>
      ...
      <div style={{
        ...
        <div>
          <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap", marginBottom: 8 }}>
            <span style={{ background: "#e07055", color: "#fff", padding: "3px 12px", borderRadius: 8, fontSize: 14, fontWeight: 900 }}>
              {d.date}
            </span>
            <span style={{ background: "#edf4fb", color: "#0e2d4d", padding: "3px 10px", borderRadius: 8, fontSize: 12, fontWeight: 700 }}>
              {g(d.mood)}
            </span>
          </div>
          <div style={{ fontSize: 18, fontWeight: 900, color: "#0e2d4d", lineHeight: 1.4 }}>{g(d.title)}</div>
        </div>
        <div style={{ fontSize: 13, color: "#0e2d4d", fontWeight: 700, textAlign: "right", maxWidth: 260, lineHeight: 1.5 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        {d.slots.map((slot, slotIdx) => {
          ...
          return (
            <div key={slotIdx} style={{ borderLeft: `3px solid ${pm.border}`, paddingLeft: 14 }}>
              {/* 时间 + 时段标签 */}
              <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 8, flexWrap: "wrap" }}>
                <span style={{ fontWeight: 800, fontSize: 12, color: "#6b7280" }}>{slot.time}</span>
                <span style={{
                  background: pm.bg, color: pm.border,
                ...
                <div style={{ marginBottom: 10 }}>
                  ...
                  <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                    {slot.options.map((opt, i) => (
                      <button key={i}
                        onClick={() => setAltChoices((prev) => ({ ...prev, [slotIdx]: i }))}
                        style={{
                          padding: "5px 12px", borderRadius: 999,
                          border: chosen === i ? "2px solid #0e2d4d" : "1.5px solid #e2e8f0",
              ...
              <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 6 }}>
                ...
                <span style={{ fontWeight: 800, fontSize: 15, color: "#0e2d4d" }}>
                  ...
                  {active.venues.map((v, vi) => (
                    <div key={vi} style={{
                      ...
                      <div style={{ display: "flex", justifyContent: "space-between", gap: 8, flexWrap: "wrap", marginBottom: 4 }}>
                        <span style={{ fontWeight: 900, fontSize: 14, color: "#0e2d4d" }}>📍 {v.name}</span>
                        {v.rating && <span style={{ fontSize: 12, whiteSpace: "nowrap" }}>{v.rating}</span>}
                      </div>
                      ...
                      {v.tip && (
                        <div style={{ marginTop: 6, fontSize: 12, color: "#92400e", background: "#fef3c7", padding: "4px 8px", borderRadius: 6, lineHeight: 1.6 }}>
                          💡 {g(v.tip)}
                        </div>
                      )}
                    </div>
              ...
              {/* 外层 Tip（无论选哪个方案都显示）*/}
              {slot.tip && (
                <div style={{ marginTop: 8, fontSize: 13, color: "#065f46", background: "#d1fae5", padding: "7px 11px", borderRadius: 8, lineHeight: 1.65 }}>
                  {g(slot.tip)}
                </div>
              )}
            </div>
